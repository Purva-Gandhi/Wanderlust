...
const listingSchema = new Schema({
    ...
    image: {
        ...
        // set: function(v) {
        //     if (v === "") {
        //         console.log("Setter function triggered: Setting default image.");
    ...
    owner: { // Define owner as a single reference to a User
        type: Schema.Types.ObjectId,
        ref: "User"
    },
    geometry:{// to store center points latitude and longitude
        type:{
            type:String,
            enum:['Point'],
            required:true
